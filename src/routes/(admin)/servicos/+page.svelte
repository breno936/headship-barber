...
const res = await fetch('/api/servicos', {
  ...
  async function editService(event:any) {
    event.preventDefault();
...
<div class="overflow-x-auto">
    <table class="table">
               ...
               <div class="flex items-center gap-3">
                 <div class="avatar">
                   <div class="mask mask-squircle w-12 h-12">
                     <img src="{service.picture}" alt="Avatar Tailwind CSS Component" />
                   </div>
                 </div>
      ...
      <!--Delete Modal-->
      <ModalConfirm message="Excluir" metodo={deleteService}/>
</div>